...
<style>
  ...
  .profile_sum {background-color: #ffff; border-radius: 20px; max-width: 90%; margin-left: 5%; padding: 1%;}
  .gal {max-width: 90%;margin-left: 8%;padding: 1%;max-height: 150px;}.gimg {max-width: 100%;max-height: 100%;}.gbox {background-color: #ffff;border-radius: 10px;margin:10px;max-width: 300px;padding:0px;}.gbox p,h4{padding:10px;}.imgdate{text-align: right;padding:0px;}.hrt{position: absolute; color: red; padding:10px;}.pimg {padding: 0px;border: none;}.gbox h4{font-weight: bold;color:white;position: absolute;top:34%;}
</style>
    </head>
    <body class="antialiased" style="background-color:#db7093">
